...
label.pack(side=TOP)
filename = PhotoImage(file="D:\ML project\Driver Drowsiness\Drowsiness-monitoring-Using-OpenCV-Python-master\demo.png")
...
but5=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=blink,text='Detect Conciousness',font=('helvetica 15 bold'))
